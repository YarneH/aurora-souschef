...
public class Tab3Steps extends Fragment {
    ...
    public class StepsPagerAdapter extends FragmentPagerAdapter {
        private PlaceholderFragment[] mFragments = new PlaceholderFragment[mDescriptionSteps.length];
        ...
        public Fragment getItem(int position) {
            ...
            PlaceholderFragment fragment = PlaceholderFragment.newInstance(position, getCount());
