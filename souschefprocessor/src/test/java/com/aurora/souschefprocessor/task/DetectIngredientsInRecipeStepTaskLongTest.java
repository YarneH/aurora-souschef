...
public class DetectIngredientsInRecipeStepTaskLongTest {
    ...
    private static String initializeCorrectIngredientsInStepsString() {
        return ("NO_INGREDIENTS\n" +
                ...
                "1.0\t\twhole sea bass\n" +
                "0.5\t\tlow-sodium light soy sauce\n" +
                "\n" +
                "NO_INGREDIENTS\n" +
                "\n" +
                "1.0\t\tginger ginger\n" +
                "2.0\ttbsp\tlight Chinese lager\n" +
                "1.0\t\twhite pepper\n" +
                "1.0\t\tcracked sea salt\n" +
    ...
    private static String initializeStepsString() {
        return ("Preheat oven to 400 degrees F (205 degrees C). Butter a 9x9x2 inch baking pan.\n" +
                ...
                "\n" +
                "Combine sugar and oil; beat well. Add eggs and beat. Combine flour, baking soda, salt, cinnamon and nutmeg. " +
                ...
                "Bake until rolls or loaves are golden brown, 10 to 12 minutes for individual buns, about 20 minutes for braids. " +
                ...
                "Let them sit, covered for another 15 minutes to rise again. Preheat the oven to 425 degrees F (220 degrees C).\n" +
                ...
                "cover with a dry towel and let stand in a warm place (90 - 100F) until doubled in size, about 1 hour. Punch down dough.\n" +
                ...
                "rotating the pans after 25 minutes for more even browning. Remove from pan as soon as bread will easily lift out, " +
                ...
                "Stir the yeast into oat mixture and mix well. Add whole wheat flour, 2 cups bread flour, and the eggs. " +
                ...
                "Bake in the preheated oven until the loaves are golden brown and sound hollow when tapped, about 30 minutes.\n" +
                "\n" +
                ...
                "For the pizza base, place the flour, oil, water and salt into a food processor and blend together until a dough is formed. " +
                "Tip out onto a floured work surface and knead. Shape into a round base about 20cm/8in wide.\n" +
                "Place into a frying pan over a high heat and brown the base, then using a mini-blowtorch, crisp the top of the pizza. " +
                ...
                "remove half of the ham onto a plate and set aside. Add the mushrooms to the pan and fry for two minutes. " +
                "Add the crème fraîche and bring up to the boil. Add the pasta, Parmesan and parsley and toss together over the heat. " +
                "Season well with salt and pepper.\n" +
                "Serve with a green salad and crunchy bread.\n" +
                "\n" +
                "To make the basic dough, line a baking tray with baking parchment (you may need two baking trays or, alternatively, " +
                "cook the biscuits in batches).\n" +
                "In a bowl, use a wooden spoon or a mixer to cream together the butter, sugar and vanilla essence until just creamy. " +
                "Do not over work the batter at this stage. Beat in the egg until well combined.\n" +
                "Add the flour and mix on a low speed until a dough forms. In the bowl, use your hands to lightly knead the dough into a ball. " +
                ...
                "Cut the desired shapes. For the duck biscuits: use a duck-shaped cutter and a round cutter for the base " +
                ...
                "For the ladybird biscuits: cut out two rounds, one slightly smaller than the other (approx. 5cm/2in and 3cm/1¼in). " +
                ...
                "For the sitting down person biscuits: cut a gingerbread person out of the dough and then cut off the legs. " +
                "Trim about 2mm from around the edges of the legs and cut two slots out of the bottom of the gingerbread body, " +
                "about the depth of the legs (the legs will slot in here once baked). Also cut out two small ovals for feet.\n" +
                ...
                "To decorate the duck biscuits, thinly roll out the yellow ready-to-roll icing and cover the duck shapes. " +
                "Pipe on any decoration desired for the eyes, beaks and wings. " +
                "Position a wire rack over a container that will hold it at a suitable height to lean the stand up biscuit against. " +
                "Use the flooding technique to ice the biscuit circles (see step 10 for more information) to represent a pond. " +
                "While the icing is still wet, place the round biscuit under the edge of the wire rack. " +
                "Stand the duck biscuit in position on the wet icing on the round, using the rack as support to keep it upright. " +
                ...
                "For flooding the icing needs to be slightly runnier, so add a few drops of water. Pipe or spoon enough " +
                ...
                "Use a toothpick to spread the icing evenly inside the hard icing ‘wall’. If the surface of the icing isn’t flat, " +
                ...
                "and cover the biscuits using the flooding method described in step 10. Once the icing is completely dry, " +
                "use some leftover icing to pipe a zig zag along the bare edge of each half tree " +
                "and attach them to the middle of the whole trees Repeat at the back of the biscuit with the remaining tree halves. " +
                "You may have to hold the half trees in place while the icing sets.\n" +
                "To decorate the ladybird biscuits, brush the rounds with cooled boiled water and cover the larger round " +
                ...
                "To decorate the lamb biscuits, ice half the bodies of the lambs using the flooding technique in step 10 - " +
                "keeping the legs free of icing. Once the icing is dry, spread an undecorated lamb biscuit with icing " +
                "and sandwich to the back of the decorated biscuit. Dot some icing on the back of the individual lamb legs " +
                ...
                "Slot the legs sideways into the precut slots so the person is sitting down with their legs stretched out " +
                "in front of them. Attach the feet to the bottom of the legs using icing and leave to dry.\n" +
                "\n" +
                "Preheat the oven to 220C/200C Fan/Gas 7.\n" +
                "For the turkey and stuffing, put the turkey crown on a lightly oiled baking tray and pat dry with kitchen paper. " +
                ...
                "Thinly slice the leeks. Add to the pan and cook over a low heat for 3–4 minutes, or until softened, stirring regularly.\n" +
                ...
                "Tip the nuts and fruit onto a board and cut any large nuts in half or quarters, then add to the bread and leeks. " +
                ...
                "When the turkey has been cooking for 1 hour, take out of the oven and reduce the temperature to 200C/180C Fan/Gas 7. " +
                ...
                "Meanwhile, for the roast potatoes, put the potatoes in a large saucepan or flameproof casserole and cover with cold water. " +
                ...
                "Pour the oil over and toss together well. Scatter in a single layer onto a baking tray and roast for an hour, " +
                ...
                "Place on a lightly oiled baking tray with the potatoes and drizzle with the honey. Roast for 15–20 minutes, " +
                ...
                "Mix until well combined, then add the remaining milk and bring to a gentle simmer. Cook for 3–4 minutes, " +
                "stirring regularly, until thick and smooth, then add the cream and butter and cook for 1–2 minutes more. " +
                "Pour into a warmed dish, sprinkle with a little nutmeg, and keep warm until ready to serve.\n" +
                "For the carrots, put the carrots in a microwave-proof serving dish and pour over the orange juice, dot with butter, " +
                ...
                "in a medium saucepan and bring to a simmer. Reduce the heat and cook gently for 5 minutes, stirring occasionally. " +
                ...
                "Pour the mixture over the beef, turning to coat the joint evenly in the liquid. Cover the dish loosely " +
                "with cling film and set aside to marinate in the fridge for at least four hours, turning occasionally. " +
                "(The beef can be marinated for up to two days.)\n" +
                "When the beef is ready to cook, preheat the oven to 190C/375F/Gas 5. Lift the beef from the marinade, " +
                ...
                "Place the crusted beef into a roasting tin and roast in the oven for 1 hour 20 minutes (for medium-rare) " +
                ...
                "Set aside in a warm place to rise (prove) for at least one hour, or until the dough has doubled in size.\n" +
                ...
                "cover the centre section of the dough rectangle. Fold the other end of the dough rectangle over the folded dough, " +
                "so that the dough ends up three times its original thickness.\n" +
                "Roll the dough out again to a 40cm x 20cm/16in x 8in rectangle, about 1cm/½in thick. Repeat the process of spreading " +
                "and folding with another portion of the butter and lard mixture.\n" +
                "Repeat the process twice more, until all of the butter and lard mixture has been used up and the dough has been " +
                "rolled out a total of four times.\n" +
                "Preheat the oven to 200C/400F/Gas 6.\n" +
                "Roll the dough out again to a 40cm x 20cm/16in x 8in rectangle, about 1cm/½in thick. Cut the dough into 16 pieces " +
                "and roll each into a round, flat bun shape.\n" +
                "Transfer the buns to a lightly oiled baking tray and set aside for 40-45 minutes, or until they have doubled in size " +
                ...
                "Before serving add all the rest of the ingredients and mix well for a quick delicious pickle to serve with the fish.\n" +
                "For the sea bass, prepare the fish by rinsing it under cold running water and pat dry with paper towels. " +
                "Cut two slits into both sides of the fish and season with salt and white pepper.\n" +
                "Stuff the slits and inside the belly cavity with the sliced ginger. Place the fish on a heatproof plate " +
                "(making sure that the plate and fish fit inside the bamboo steamer without covering up all of the steam " +
                "holes around the edges of the plate). Set aside another bamboo steamer tray and plate to use for the clams.\n" +
                "Pour half of the light Chinese lager over the fish. Place the plate of fish in a bamboo steamer, " +
                "stack and cover with the lid. Place the whole steamer basket over a wok that is three-quarters full with boiling water, " +
                ...
                "about 8-10 minutes (depending on the thickness of the fish. Don’t steam it too long or the skin will separate, " +
                ...
                "and coriander cress over the top. Pour over the low-sodium light soy sauce, followed by the toasted sesame oil. " +
                "Pour over the hot peanut oil and it will create a sizzle as it heats up the spring onions and herbs.\n" +
                "In the traditional Chinese way the fish is served whole in the steamer at the table because it symbolises " +
                ...
                "the goji berry and swede quick ‘pickle’, blanched baby pak choi leaves, spring onion curls and the coriander micro herbs. " +
                ...
                "Now all you do is simply add all the other cake ingredients (except the icing sugar) to the bowl and, " +
                ...
                "The cakes will take 30-35 minutes to cook, but do not open the oven door until 30 minutes have elapsed.\n" +
                ...
                "\n" +
                "Preheat the oven to 350°. Butter the bottom and sides of each layer-cake pan with the softened butter, " +
                "using your hands, then sprinkle the flour inside and shake this around so you get a thin coating on the butter. " +
                "Tip out any excess.\n" +
                ...
                "(don’t shake the flour down, or it will become dense) and then tip the measured flour into a mixing bowl. " +
                ...
                "and sift it over the flour. Then mix the baking powder and salt lightly with the flour, using your hands.\n" +
                "Next, Put the butter into a second, large mixing bowl. If it is very firm " +
                "(it shouldn’t be, if you have left it out of the refrigerator), squeeze it through your fingers until it softens up. " +
                ...
                "or an electric hand beater until they mount first to soft, drooping peaks and then to firm, glossy peaks. " +
                ...
                "dividing it equally between them. Give the filled pans a little knock on the countertop to level the batter.\n" +
                ...
                "and invert so the cake comes out onto the rack, top side down. Then reverse the layers so they are top side up.\n" +
                ...
                "and bread crumbs and mix well. Add ¼ cup of the olive oil and mix well with your hands or a spoon. Set aside.\n" +
                "Cut six 15-inch-long pieces of kitchen twine. Open out the beef, season on both sides with salt and pepper, " +
                "and place it on a work surface so a long side is toward you. " +
                "Spread the bread crumb mixture evenly over the beef, leaving a ½-inch border along the side farthest from you; " +
                ...
                "Brush gently on both sides with the remaining 3 tablespoons olive oil and season with salt and pepper.\n" +
                ...
                "Stir-fry for a minute, then add the onions. Cook for 6 to 8 minutes, until they're starting to turn golden, " +
                "then add the garlic and ginger. Cook for another couple of minutes before adding the chopped tomatoes.\n" +
                ...
                "Cover the buche with the remaining buttercream, making sure to curve up the protruding branch on the top, " +
                ...
                "or 20 to 25 minutes by hand. I actually like to turn the dough out of the mixer at this point and hand-knead. " +
                "The technique is simple (and great for relieving stress—cheaper than a therapist!). " +
                "Slap the dough onto the counter, then with the heel of one hand push it through the middle into the counter. " +
                "With the other hand, fold the far side of the blob towards you, over onto itself, " +
                "and rotate the dough about 90 degrees. Repeat this pushing, folding and rotating cycle several times, " +
                "then give the dough another good hard slap onto the counter. (Don’t add any extra flour at this point, " +
                ...
                "pinch some of the dough and pull it upwards. When the dough is ready, it should feel springy and elastic.\n" +
                ...
                "in a large mixing bowl with a wooden spoon. Knead or beat the butter into the dough in small portions, " +
                "fully incorporating each addition before adding the next. This process is definitely easier with a dough hook, " +
                ...
                "The butter should be malleable, but not overly soft, and the dough should not get too warm during this process.\n" +
                ...
                "from the sides of the bowl in a smooth entity, or should neatly roll on the counter, no longer sticky or tacky. " +
                ...
                "The buttery side should now be facing up. Cover again with plastic wrap and refrigerate for 2 to 3 hours. " +
                "Punch the dough down, flip it once more, cover the bowl with plastic and weigh it down with a plate or dish, " +
                "making sure the dough won’t be able to creep around the sides of the weight and escape the confines of its bowl. " +
                "(I have seen renegade doughs running rampant over the bottles and jars on refrigerator shelves more than once, " +
                "and it’s not a mess that you will forget having to clean up! Not to mention the waste of time, energy " +
                "and perfectly good butter.) Return the bowl to the coldest part of your refrigerator and leave there overnight. " +
                "If the dough is left longer than 8 hours, check periodically to make sure it has not risen above the bowl; " +
                "gently punch it down as necessary. The brioche dough may be frozen at this point, wrapped very securely. " +
                "Allow the dough to thaw in the refrigerator for 4 to 7 hours, then proceed with the shaping, final rising and baking.\n" +
                ...
                "and tap with the hammer to crack a hole there. Insert the knife and cut the conch away from the shell. " +
                ...
                "then dredge in flour, dipping your fingers in buttermilk as you pack flour on to help create moistened, " +
                ...
                "30 minutes. Cool the cakes completely in the pans on cooling racks and then turn them out onto the racks.\n" +
                ...
                "3. Using an offset spatula, spread a thin layer of the orange frosting over the flat surface of 1 cake. " +
                ...
                "curving it from bottom to top. Lift it off, reposition it, and press again. Repeat all around the cake. " +
    ...
    private static String initializeIngredientsString() {
        return ("0.5\tcup\tunsalted butter\n" +
                ...
                "2.0\t\trashers smoked streaky back bacon\n" +
                ...
                "1.0\tof\tbutter\n" +
                "2.0\ttbsp\tfreshly chopped parsley\n" +
                "2.0\tgood\tpinches caster sugar\n" +
                "25.0\tg\tbutter\n" +
                "4.0\trashers\tstreaky bacon\n" +
                ...
                "6.0\t\tpassion fruit\n" +
                "250.0\tg\tmascarpone\n" +
                "1.0\tlevel\tdessertspoon golden caster sugar\n" +
